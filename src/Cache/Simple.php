...
class Simple implements CacheInterface
{
	...
	/**
	 * @var \Collei\Cache\Pool
	 */
	protected $pool;

	/**
	 * Instantiate the simple cache.
	 *
	 * @param string $path
	 * @return void
	 */
	public function __construct(string $path)
	{
		...
		if (! is_dir($path)) {
			throw new InvalidArgumentException('path must exist and be writable');
		}
